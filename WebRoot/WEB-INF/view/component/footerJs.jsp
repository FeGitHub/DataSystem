	...
	<script type="text/javascript" src="${BASE_PATH}/js/pagejs/template/template.js"></script>	
	<script type="text/javascript" src="${BASE_PATH}/js/pagejs/template/app-notification.js"></script><!--信息通知构建-->
    <script type="text/javascript" src="${BASE_PATH}/js/pagejs/template/app-menu.js"></script> <!--主菜单构建-->
