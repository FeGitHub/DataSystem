...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <script src="${BASE_PATH}/js/test/popper.min.js"></script>
    <script src="${BASE_PATH}/js/test/bootstrap.min.js"></script>
    <script src="${BASE_PATH}/js/test/main.js"></script>
    <!-- The javascript plugin to display page loading on top-->
    <script src="js/plugins/pace.min.js"></script>
    <!-- Page specific javascripts-->
    <script type="text/javascript" src="${BASE_PATH}/js/test/plugins/bootstrap-datepicker.min.js"></script>
    <script type="text/javascript" src="${BASE_PATH}/js/test/plugins/select2.min.js"></script>
    <script type="text/javascript" src="${BASE_PATH}/js/test/plugins/bootstrap-datepicker.min.js"></script>
